        ...
        public override async Task MultipleHello(HelloRequest request, IServerStreamWriter<HelloResponse> responseStream, ServerCallContext context)
        {
            ...
            while (/*!context.CancellationToken.IsCancellationRequested &&*/ j++ < 10)
            {
                ...
                for (var i = 0; i < _store.RowCount2; i++)
                {
                    ...
                    for (var k = 0; k < _store.Columns.ColumnList.Length; k++)
                    {
                        response.P1 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P2 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P3 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P4 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P5 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P6 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P7 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P8 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P9 = row[_store.Columns.ColumnList[k]].ToString();
                        response.P10 = row[_store.Columns.ColumnList[k]].ToString();
                    }
